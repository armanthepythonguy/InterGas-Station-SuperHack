...
export declare function moduleCanCertainlyVerify(destModuleAddress: types.Address, multiProvider: MultiProvider, origin: ChainName, destination: ChainName): Promise<boolean>;
