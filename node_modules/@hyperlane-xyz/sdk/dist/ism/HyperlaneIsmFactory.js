...
function moduleCanCertainlyVerify(destModuleAddress, multiProvider, origin, destination) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const module = core_1.IInterchainSecurityModule__factory.connect(destModuleAddress, provider);
        try {
            ...
            if (moduleType === types_1.ModuleType.MERKLE_ROOT_MULTISIG ||
                ...
                const multisigModule = core_1.IMultisigIsm__factory.connect(destModuleAddress, provider);
                const [, threshold] = yield multisigModule.validatorsAndThreshold(message);
                return threshold > 0;
            }
            else if (moduleType === types_1.ModuleType.ROUTING) {
                const routingIsm = core_1.IRoutingIsm__factory.connect(destModuleAddress, provider);
                ...
                const aggregationIsm = core_1.IAggregationIsm__factory.connect(destModuleAddress, provider);
            ...
            utils_1.logging.warn(`Error checking module ${destModuleAddress}: ${e}`);
            return false;
        }
    });
}
