...
function chainMetadataToWagmiChain(metadata) {
    ...
    return {
        ...
        blockExplorers: ((_a = metadata.blockExplorers) === null || _a === void 0 ? void 0 : _a.length)
            ? {
                default: {
