import { Mailbox, TimelockController, ValidatorAnnounce } from '@hyperlane-xyz/core';
...
export declare class HyperlaneCoreDeployer extends HyperlaneDeployer<CoreConfig, CoreFactories> {
    ...
    deployTimelock(chain: ChainName, delay: number, owner: types.Address): Promise<TimelockController>;
