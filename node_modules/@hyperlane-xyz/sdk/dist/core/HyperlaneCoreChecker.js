...
class HyperlaneCoreChecker extends HyperlaneAppChecker_1.HyperlaneAppChecker {
    ...
    checkChain(chain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.checkTimelockController(chain);
        });
    }
    checkTimelockController(chain) {
        return __awaiter(this, void 0, void 0, function* () {
            const config = this.configMap[chain];
            if (config.upgradeTimelockDelay) {
                const timelockController = this.app.getContracts(chain).timelockController;
    ...
    checkMailbox(chain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const config = this.configMap[chain];
            const matches = yield (0, HyperlaneIsmFactory_1.moduleMatchesConfig)(chain, actualIsm, config.defaultIsm, this.ismFactory.multiProvider, this.ismFactory.getContracts(chain));
            if (!matches) {
                const violation = {
