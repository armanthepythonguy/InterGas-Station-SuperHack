...
class HyperlaneDeployer {
    ...
    deployContractFromFactory(chain, factory, contractName, constructorArgs, initializeArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (initializeArgs) {
                ...
                const initTx = yield contract.initialize(...initializeArgs, overrides);
    ...
    changeAdmin(chain, proxy, admin) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.runIfAdmin(chain, proxy, () => this.multiProvider.handleTx(chain, proxy.changeAdmin(admin, txOverrides)), (proxyAdmin) => this.multiProvider.handleTx(chain, proxyAdmin.changeProxyAdmin(proxy.address, admin, txOverrides)));
        });
    }
